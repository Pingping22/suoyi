//
//  EducationTeachingListVC.m
//  suoyi
//
//  Created by 王伟 on 2019/2/21.
//  Copyright © 2019 liuhuiping. All rights reserved.
//

#import "EducationTeachingListVC.h"
//cell
#import "ContentResourcesListVC.h"

@interface EducationTeachingListVC ()

@end

@implementation EducationTeachingListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.view addSubview:[BaseNavView initNavBackTitle:@"教育学习" rightView:nil]];
    //cell
