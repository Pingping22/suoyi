...
//        }
//        return ^(NSInteger size){
//            return [NSString stringWithFormat:@"%@?x-oss-process=style/logo%ld",self,size];
//        };
//    }
//    return ^(NSInteger size){
//        return self;
...
- (NSMutableAttributedString *)setAttributeImageName:(NSString *)imageName imageRect:(CGRect)rect withIndex:(NSUInteger)index{
    ...
    NSMutableAttributedString * tittleAttr = [[NSMutableAttributedString alloc]initWithString:self];
