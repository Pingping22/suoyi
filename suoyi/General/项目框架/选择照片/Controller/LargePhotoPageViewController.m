...
- (UIView *)bottomToolBar
{
    if (!_bottomToolBar) {
        ...
        [completeBtn setTitle:@"上传" forState:UIControlStateSelected];
        [completeBtn setTitle:@"上传" forState:UIControlStateNormal];
        [completeBtn setTitleColor:[UIColor orangeColor] forState:UIControlStateSelected];
        [completeBtn setTitleColor:[UIColor clearColor] forState:UIControlStateNormal];
...
- (void)setupNav
{
    ...
    [self.view addSubview:[BaseNavView initNavBackTitle:@"" rightView:self.selectBtn]];
...
- (void)initPageVC
{
    ...
    self.pageVC.view.frame  = CGRectMake(0, NAVIGATIONBAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - NAVIGATIONBAR_HEIGHT);
