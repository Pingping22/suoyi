...
//            NSAttributedString *str = [GlobalMethod returnNSAttributedStringWithContentStr:[NSString stringWithFormat:@" %@",model.desc] titleColor:COLOR_DETAIL withlineSpacing:W(4) withAlignment:0 withFont:[UIFont systemFontOfSize:F(14)] withImageName:@"dt_tri" withImageRect:CGRectMake( 0,2,W(7), W(6)) withAtIndex:0];
