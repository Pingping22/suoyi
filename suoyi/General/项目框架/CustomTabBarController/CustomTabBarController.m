...
- (void)viewDidLoad {
    ...
    // 添加子控制器
    [self setUpChildVC:[HomePageVC new] title:@"资讯" image:@"icon-sy-gray" selectedImage:@"icon-sy-green"];
    [self setUpChildVC:[RecommendTabVC new] title:@"推荐" image:@"icon-wd-gray" selectedImage:@"icon-wd-green"];
    [self setUpChildVC:[ToolsTabVC new] title:@"产品" image:@"icon-gj-gray" selectedImage:@"icon-gj-green"];
