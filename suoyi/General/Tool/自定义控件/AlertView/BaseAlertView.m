...
- (UIView *)viewBg{
    if (_viewBg == nil) {
        _viewBg = [UIView new];
        _viewBg.backgroundColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.6];
    }
    return _viewBg;
}
- (UIView *)viewWhite{
...
- (UILabel *)labelAlert{
    if (_labelAlert == nil) {
        ...
        [GlobalMethod setLabel:_labelAlert widthLimit:0 numLines:0 fontNum:F(19) textColor:COLOR_LABEL text:@""];
...
- (UILabel *)labeTitle{
    if (_labeTitle == nil) {
        ...
        [GlobalMethod setLabel:_labeTitle widthLimit:0 numLines:0 fontNum:F(14) textColor:COLOR_LABEL text:@""];
...
- (UILabel *)label{
    if (_label == nil) {
        _label = [UILabel new];
        [GlobalMethod setLabel:_label widthLimit:0 numLines:0 fontNum:F(17) textColor:COLOR_LABEL text:@""];
    }
    return _label;
}
