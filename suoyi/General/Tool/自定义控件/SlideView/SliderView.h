...
@property (nonatomic, assign) CGFloat   titleFontNum;   //字体大小
@property (nonatomic, strong) UIColor * textColorSelect;//字体点击颜色

//自定义
//- (instancetype)initWithFrame:(CGRect)frame isHasSlider:(BOOL)isHasSlider isImageLeft:(BOOL)isImageLeft isScroll:(BOOL)isScroll delegate:(id)delegate;
